...
import HousePlus from '~icons/lucide/house-plus'
...
import MoveVertical from '~icons/lucide/move-vertical'
...
import KeySquare from '~icons/lucide/key-square'
...
import FileMinus from '~icons/lucide/file-minus'
...
import FolderMinus from '~icons/lucide/folder-minus'
...
import ImageMinus from '~icons/lucide/image-minus'
import Images from '~icons/lucide/images'
import FolderUp from '~icons/lucide/folder-up'
import FolderDown from '~icons/lucide/folder-down'
...
import PenSquare from '~icons/lucide/pen-square'
...
import AlertOctagon from '~icons/lucide/alert-octagon'
...
import Shell from '~icons/lucide/shell'
...
export const iconMap = {
  ...
  'more-horizontal': MoveHorizontal,
  'more-vertical': MoveVertical,
  'move': Move,
  'maximize': Maximize,
  'minimize': Minimize,
