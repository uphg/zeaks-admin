...
export class HTTPClient {
  ...
  async post<T>(url: string, data?: Record<string, any>, config?: HTTPConfig): Promise<HTTPResponse<T>> {
    return this.request<T>('POST', url, data, config)
  }

  async put<T>(url: string, data?: Record<string, any>, config?: HTTPConfig): Promise<HTTPResponse<T>> {
